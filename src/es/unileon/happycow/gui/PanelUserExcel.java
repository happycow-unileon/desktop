...
public class PanelUserExcel extends javax.swing.JPanel{
    ...
    public void setListEvaluations(LinkedList<InterfaceEvaluationModel> list){
    ...
    public void buttonAllEvaluations(){
        if(controller!=null){
            controller.selectedAllEvaluations();
        }
    }
    
    public void buttonAllFarms(){
        if(controller!=null){
            controller.selectedAllFarm();
        }
    }
    
    public void buttonNoEvaluations(){
        if(controller!=null){
            controller.selectedNoneEvaluations();
        }
    }
    
    public void buttonNoFarms(){
        if(controller!=null){
